...
const ParticleCard = memo(function ParticleCard({
  children,
  className = "",
...
const GlobalSpotlight = memo(function GlobalSpotlight({
  gridRef,
  disableAnimations = false,
  enabled = true,
...
const BentoCardGrid = memo(function BentoCardGrid({ children, gridRef }) {
  return (
...
/* A lightweight non-particle card with proper cleanup */
const BaseInteractiveCard = memo(function BaseInteractiveCard({
  children,
  className,
  style,
